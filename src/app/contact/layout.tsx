...
export const metadata: Metadata = {
  ...
  description: 'Hubungi CV Jasa Sukses Abadi untuk konsultasi, penjadwalan layanan kalibrasi, tera, dan perbaikan alat ukur. Kami berlokasi di Hajimena, Natar, Lampung Selatan.',
  keywords: [
