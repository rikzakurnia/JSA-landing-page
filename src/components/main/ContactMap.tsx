...
const ContactMap = () => {
  return (
    <section className="py-20 md:py-32 px-6 xl:px-16 max-w-7xl mx-auto">
      <div className="flex flex-col-reverse lg:flex-row gap-12 lg:gap-24 items-stretch">
        
        {/* KOLOM KIRI (Desktop) / BAWAH (Mobile): PETA GOOGLE MAPS */}
        <div className="w-full lg:w-2/4 min-h-[350px] md:min-h-[450px] bg-slate-100 rounded-3xl md:rounded-[4rem] overflow-hidden shadow-2xl shadow-brand-purple/10 border border-slate-200 relative">
           <iframe
        ...
        {/* KOLOM KANAN (Desktop) / ATAS (Mobile): INFORMASI KANTOR */}
        <div className="w-full lg:w-2/4 flex flex-col justify-center">
          <div className="mb-8 md:mb-10">
            <span className="text-brand-green font-bold text-xs uppercase tracking-[0.1em]">Contact Us</span>
          ...
          <div className="space-y-8 md:space-y-10">
            ...
            <div className="space-y-6 md:space-y-7">
              <div className="flex gap-4 md:gap-5">
                <div className="flex-shrink-0 w-10 h-10 md:w-12 md:h-12 bg-brand-purple/5 rounded-xl flex items-center justify-center text-brand-purple border border-brand-purple/5">
                ...
                <div>
                  ...
                  <p className="text-sm text-brand-purple font-semibold leading-relaxed">
